...
+scope+:: specifies the scope within which lists are ordered (default: 1 = 1, i.e., a global list)
  ...
  The +scope+ option can be supplied as a symbol or as a string.  The generated scope condition
  ...
  +scope => "type_id = #{type_id}":: yields "type_id = 99"
...
The plugin is a modestly modified version of the rails acts_as_list plugin release under the
